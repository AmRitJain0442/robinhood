...
export const readOnlyTools = new Set(['list_files', 'read_file', 'glob_files', 'search_files', 'todo_read', 'todo_write', 'ask_user', 'goal_read']);

export class Capabilities {
  definitions: ToolDefinition[] = [...toolDefinitions, ...taskTools];
